...
5 points off for tardiness.

# Question 1

The intention was to show histograms for all nine generations, but your plots capture the spirit.

# Question 2, -2

Need the combination of `facet_wrap(~indic)` and `geom_point(alpha=I(1/5))`.

# Question 3, -3

Instead of duplicating/renaming lines, use iteration.
`framed6_ci` and `framed8_ci` are incorrect.
Plot is good alternative, but need to indicate treatment.
