...
## Number 7: you just used the wrong argument name. predict() uses 'newdata' 
## as an argument name for the new data frame, so 
predict(mod,newdata=newdat) ## will give you the correct answer.
```
